...
- **Darstellung**: Schriftart für App-Liste UND separat für die Uhr (je 5
  Optionen: Mono, Mono Bold, Kondensiert Bold, Grotesk Black, Serif),
  Farb-Regler für Hintergrund/Schrift/Akzent (0-100: Schwarz → Farbkreis →
  Weiß, ein Regler pro Farbe), Uhr-Format, Statusleiste ausblenden,
  Schriftgrößen für Uhr/Datum/App-Liste einzeln regelbar
...
- Die Fonts sind Android-System-Schriftfamilien (Mono/Kondensiert Bold/
  Grotesk Black/Serif), keine echten Custom-Fonts wie im Moodboard – dafür
