...
class NotesFragment : Fragment(R.layout.fragment_notes) {
    ...
    // Wartet auf den tatsaechlichen Abschluss des naechsten Layout-Durchlaufs
    // (statt einer festen Anzahl an post()-Aufrufen zu vertrauen) - dadurch
    // wird die Zeile korrekt nachgemessen, NACHDEM ein Zeilenumbruch ihre
    // Hoehe veraendert hat. Zusaetzlich ein kleiner Sicherheitsabstand zur
    // Tastatur, damit nichts knapp abgeschnitten wird.
