...
class HomeFragment : Fragment(R.layout.fragment_home) {
    ...
    private fun applyPaletteAndFonts() {
        ...
        val mainTypeface = FontFamilies.buildTypeface(Prefs.getFontFamily(context))
        val clockTypeface = FontFamilies.buildTypeface(Prefs.getClockFontFamily(context))
    ...
    private fun updateDock(view: View) {
        ...
        val slots = listOf(
            Triple(R.id.dockPhone, Intent(Intent.ACTION_DIAL), android.R.drawable.sym_action_call),
            Triple(R.id.dockCamera, Intent("android.media.action.IMAGE_CAPTURE"), android.R.drawable.ic_menu_camera),
            Triple(R.id.dockMessage, Intent(Intent.ACTION_VIEW, Uri.parse("sms:")), android.R.drawable.ic_menu_send),
            Triple(R.id.dockMail, Intent(Intent.ACTION_VIEW, Uri.parse("mailto:")), android.R.drawable.ic_dialog_email)
        )
            ...
            if (assignedPkg != null) {
                try {
                    ...
                    imageView.setOnClickListener {
                        pm.getLaunchIntentForPackage(assignedPkg)?.let { startActivity(it) }
                    }
    ...
    private fun populateFavorites() {
        ...
        val palette = Palettes.current(context)
        val typeface = FontFamilies.buildTypeface(Prefs.getFontFamily(context))
