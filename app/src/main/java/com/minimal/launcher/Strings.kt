...
object Strings {
    ...
    private val table: Map<String, Pair<String, String>> = mapOf(
        ...
        "row_timelimit_durations" to ("Zeitlimit-Längen" to "Time Limit Durations"),
        "row_timelimit_option" to ("Option" to "Option"),
        ...
        "notes_copy" to ("Kopieren" to "Copy"),
        "notes_cancel" to ("Abbrechen" to "Cancel"),
        "notes_copied_toast" to ("Kopiert" to "Copied"),

        // Kontextmenü im App-Drawer (langes Drücken auf eine App)
        "context_rename" to ("Umbenennen" to "Rename"),
        "context_hide" to ("Ausblenden" to "Hide"),
        "context_uninstall" to ("Deinstallieren" to "Uninstall"),
        "context_uninstall_title" to ("Wirklich deinstallieren?" to "Really uninstall?"),

        // Einrichtungs-Assistent
        "setup_title" to ("Einrichtung" to "Setup"),
        "setup_subtitle" to (
            "Tippe jeden Punkt an - Android fragt dich dabei jeweils selbst um Bestätigung." to
            "Tap each item - Android will ask you to confirm each one yourself."
        ),
        "setup_default_launcher" to ("Als Standard-Startbildschirm festlegen" to "Set as default home screen"),
        "setup_usage_access" to ("Nutzungszugriff erlauben" to "Allow usage access"),
        "setup_notification_access" to ("Benachrichtigungszugriff erlauben" to "Allow notification access"),
        "setup_overlay" to ("Anzeige über anderen Apps erlauben" to "Allow display over other apps"),
        "setup_done" to ("Fertig" to "Done"),
        "row_setup_wizard" to ("Einrichtungs-Assistent erneut öffnen" to "Reopen Setup Wizard"),

        // Wetter
        "section_weather" to ("Wetter" to "Weather"),
        "row_weather_show" to ("Wetter anzeigen" to "Show Weather"),
        "row_weather_gps" to ("GPS für Standort verwenden" to "Use GPS for Location"),
        "row_weather_location" to ("Ort festlegen" to "Set Location"),
        "row_weather_size" to ("Schriftgröße Wetter" to "Weather Font Size"),
        "weather_location_dialog_title" to ("Ort eingeben" to "Enter Location"),
        "weather_location_not_found" to ("Ort nicht gefunden" to "Location not found"),
        "weather_current_location" to ("Aktueller Standort (GPS)" to "Current Location (GPS)"),
        "row_weather_custom_link" to ("Eigener Wetter-Link" to "Custom Weather Link"),
        "weather_custom_link_dialog_title" to (
            "Vollständiger Link (z.B. mit deiner Stadt), leer = Google" to
            "Full link (e.g. including your city), empty = Google"
        )
    )
