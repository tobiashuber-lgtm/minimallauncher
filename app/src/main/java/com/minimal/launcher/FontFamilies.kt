...
object FontFamilies {
    ...
    fun buildTypeface(context: Context, key: String): Typeface {
        ...
        return try {
            when (family) {
                ...
                "jetbrains_mono" -> variableWeight(context, "fonts/jetbrains_mono_variable.ttf", if (bold) 700 else 400)
    ...
    // Variable Fonts (JetBrains Mono, Space Grotesk) liegen als Asset-Datei
    // vor (nicht als res/font-Ressource) - so funktioniert die zuverlaessige
    // Typeface.Builder(AssetManager, String)-Variante mit Gewichts-Einstellung.
